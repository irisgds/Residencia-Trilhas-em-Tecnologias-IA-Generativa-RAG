...
“Revista de<br>Sociologia<br>€ Politica<br><!-- End of picture text -->

DOI 10.1590/1678-98732433e018 

## Rafael Cardoso Sampaio<sup>I</sup> fio) ✉ 

IPrograma Pós-Graduação em Ciência Política, Universidade Federal do Paraná, Curitiba, PR, Brasil. 
...
Recebido em 23 de Julho de 2025. Aprovado em 5 de Novembro de 2025. Aceito em 2 de Dezembro de 2025. Editor Científico: Adriano Codato ® Editor Associado: Adriano Codato fio) 

### **I. Introdução** 

integração da inteligência artificial generativa (IAG) na produção de conhecimento acadêmico, acelerada por ferramentas como o AChatGPT, evoluiu rapidamente de uma postura de cautela para uma adoção ampla, motivada especialmente pela promessa de maior eficiência. A capacidade de automatizar ou acelerar diversas fases do trabalho acadêmico gerou otimismo (Pereira et al., 2024). Contudo, essa incorporação massiva também levanta questionamentos sobre a integridade da pesquisa, a originalidade do pensamento e o desenvolvimento das competências cognitivas dos próprios acadêmicos (Lopes et al., 2024; Sampaio et al., 2024). 
...
Rev. Sociol. Polit., v. 33, e018, 2025 
...
|Escrita|2. Escrita assistida e cu-<br>radoria crítica|_Brainstorming_, análise e revisão<br>contínua|Usar a IA para expandir ideias, aprofundar refle-<br>xão crítica e refinar progressivamente o conteúdo.|
...
|Pós-<br>escrita|4. Verificação rigorosa de<br>fatos e fontes|Validação independente de infor-<br>mações|Assegurar a precisão factual, bibliográfica, lógica<br>e ausência de plágio.|
||5. Responsabilidade final e<br>transparência|_Accountability_e declaração de<br>uso|Assumir responsabilidade integral pelo trabalho e<br>declarar transparentemente o uso de IA.|
...
||Para editar texto existente quanto à gramática, ortografia ou organização.<br>Para localizar e gerar exemplos para conteúdo existente.<br>Para fazer_brainstorming_e sugerir formas de organizar um artigo ou o título de um artigo/seção.<br>Para validar e/ou oferecer_feedback_sobre ideias, texto e código existentes.|
|Divulgação obrigatória|A IA teve impacto na geração, síntese ou decisão do conteúdo central da pesquisa.<br>Para formular perguntas, hipóteses, elaborar e conduzir experimentos.<br>Para redigir partes do artigo, resumir, parafrasear, revisar significativamente ou sintetizar conteúdo<br>textual.<br>Para traduzir partes ou a totalidade do artigo.|
|Fonte: baseado emResn|ik & Hosseini (2025).|
||exigiram verificação (Trindade & Oliveira, 2024). Essa análise permite identi-<br>ficar o que a interação revelou sobre o próprio processo de escrita.|
...
- Figura 3 - Ferramenta de IA MaxAI que ao ser acionada quando selecionado um texto, apresenta todas essas opções para reformular o texto e mesmo um espaço para um _prompt_ personalizado. 
...
<!-- Start of picture text -->
2 OA F Wx - toon. + tne |-(BJ4 er EAS oBa: 758 wecemin a-x<br>‘com as préprias palavras do autor, ajustando o vocabulirio, o tom eo estilo para garantir que<br>6 texto reflita sua voz tinica (Lopes et al., 2024b; Pereira et al., 2024; Trindade & Oliveira,<br>2024),<br>interpretacao pesquisadore andlisedeveoriginal, reorganizarelementosparigrafos,que ainsevirtransigdesIA frequentementelégicasnioe acrescentarpode fornecersua<br>(Floridi, 2025). Portanto, estamos falando de uma apropriagio que acrescenta de modo<br>significative a parte Immana da autoria, como o pensamento critico, a criatividade, ou<br>simplesmente a “alma ao texto”, j4 que textos de IA usualmente soam com muito genéricos, Gere novas ideias<br>‘téenicos e justamente sem o toque humano. A leitura do texto em voz alta é uma técnica<br>proficua para identificar dissonincias e garantir que 0 resultado soe coeso, sem "costuras”<br>‘que revelema origem mecanica de certas passagens. °<br>Aqui, € preciso cuidado especial com 0 Qj. o.cnan + dataprint, ou p<br>seja, as marcas deixadas pelos dados de treinan: ‘olvimento dos<br>grandes modelos de linguagem. Como ja saben % tm Jas nos dados<br>disponiveis na internet, o que significa que reprodt * tr sentes, como a<br>maior presencaSem cuidadode textosdevido, em lingua inglesatodos esses vieses e de pai!irt ©T cessstem! texto e mesmo ©innergees ons peenrcGage<br>“vicios de linguagem das méquinas” se transformario HOS Seis prOpri6s, como, no atual<br>momento, pode ser visto nos usos abusivos de certas palavras (“crucial”, “essencial”); die ciel<br>expresses (“insights valiosos”); tradugdes incorretas, como "rica tapecaria" que vem do<br>inglés "sich tapestry; marcadores de texto (“-") e formas de construir oragBes subordinadas Pe pare ah<br>com dois pontos “:” e ponto e virgula “;"(ver Sampaio & Figueiredo, 2025). Em suma, 0 +5 *<br>objetivo é nao deixar que a IA “lave”a sua escrita,<br><!-- End of picture text -->
...
<!-- Start of picture text -->
(Floridi, 2025). Portanto, estamos falando de uma apropriagao que acrescenta de modo<br>significative a parte humana da autoria, como 0 pensamento critico, a criatividade, ou<br>simplesmente a “alma ao texto”, jd que textos de IA usualmente soam com muito genéricos,<br>técnicos © justamente sem o toque humano. A leitura do texto em voz alta é uma técnica<br>proficua para identificar dissondncias e garantir que o resultado soe coeso, sem "costuras"<br>que revelem a origem mecanica de certas passagens.<br>1 Reformular x<br>Panto, a aproparto do texto gerade pr 1A deve apega alo signcatho@ autora humana funds elementos come pensamento<br>etc,Carerscatvdadeou, smplesmente, "aa 20x" ss0€ cuca, sto que os tenos de endem a Ser genéias, cic@<br>na nicade um fastoepara pessoaldeniicarnconsitnciase<br>"costes" qe derunciaiam a orgem mecca deceasaseegur p ss ges, a r a  cesta garanndo 6 alturawndor sutado e to em fal voratm s a . Ete rua mado ada harmoniso. a eiinar<br>asi<br>gn pd bl aro wai i phi Ua oo<br>AAU Subst<br><!-- End of picture text -->
...
<!-- Start of picture text -->
©P @ inteigente » @ Portugu...v ax<br>Poca<br>& 1A para editarou gerar. o eo<br>suoerdoe ~» |4o de uma apropriagdo que acrescenta de modo<br>2 Melnorar<br>a escrte ~ }i, como o pensamento critico, a criatividade, ou<br>coarousevearsoeto ixtos de IA usualmente soam com muito genéricos,<br>3 schorsaisscte imo. A leitura do texto em voz alta é uma técnica<br>Y Cortigrontogratie gramética arantir que 0 resultado soe coeso, sem "costuras"<br>= ener vassagens.<br>= com 0 qu 7 Reviser (2025) chama de dataprint, ou<br>e treinamento e técnicas de desenvolvimento dos<br>+ we<br>ja sabemos, as IAs foram treinadas nos dados<br>‘& Simplificar linquagem . .<br>2 & Feproduzem todos os vieses ali presentes, comoa<br>Laeavs parivuiyus uv wenn vise sagen agevud © de paises do norte global.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
|| 4 = = = = HASKAL ssCite<br>al, 2024: Trindade & Oliveira, 2024)<br>O pesquisador deve reorganizar paragrafos, inserir transicdes légicas e acrescentar<br>‘sua interpretacdo e andlise original, elementos que a IA frequentemente nado pode<br>fornecer (Floridi, 2025). Portanto, estamos falando de uma apropriacéo que<br>acrescenta de modo significativo a parte humana da autoria, como o pensamento<br>critico, a criatividade, ou simplesmente a “alma ao texto", jé que textos de 1A<br>usualmente soam com muito genéricos, técnicos e justamente sem o toque humano.<br>A ¥/]Askleitura Al doto writetexto anythingem voz altae.g... "Writeé umaan introductiontécnica7 proficuaon -climatepara< identificar<I 1. a origemdissonanciasmecénica e<br>Draft with Al }) que Floridi (2025) chama de gataprint, ou<br>Continue writing with citations } treinamento e técnicas de desenvolvimento<br>. imo jé sabemos, as IAs foram treinadas nos<br>2 Outline Builder<br>gnifica que reproduzem todos os vieses ali<br>Generate from page xtos em lingua inglesa e de paises do norte<br>Z. Write introduction<br>2. Write Conclusion iro diretamente para 0 seu texto e mesmo,<br>£ Write Opposing Arguments ansformarao nos seus prdprios, como, no<br>ibusivos de certas palavras (“crucial”,<br>‘Tum into 18"); tradugées incorretas, como "rica<br>Hi Heading 1 1y: marcadores de texto (‘—")e formas de<br>ye ‘peadinga pontos *:” e pontoe virgula *;"(ver Sampaio<br>» €ndo deixar que a IA “lave” a sua escrita.<br><!-- End of picture text -->
